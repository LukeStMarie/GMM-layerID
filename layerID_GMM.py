...
def testing(img_file, n_clusters, master_cat_file):
    """
    ...
    ----------
    img_file : str
        Location of image file. (i.e., "...\\RSGR003\\All\\4A1.jpg")
    n_clusters : int
...
# img_file = "ImageSetB/Chip49Flake08.jpg"

# args2 = {'img_file': img_file,
#         'n_clusters': 5,
